                ...
                <div class="">
					...
					try {
						...
						if (isset($_POST["categoryID"])) {
							...
							$data = $db->select("*", "category", "categoryID='$categoryID'");
							$category = $data->fetch(PDO::FETCH_ASSOC);
						}
						if (isset($_POST["update"])) {
							$categoryID = $_POST["categoryID"];
							$categoryName=$_POST["categoryName"];
							$db->update("category","categoryName='$categoryName'","categoryID='$categoryID'");
                                    ...
                                    <form id="demo-form2" method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="add-category" name="categoryName"
