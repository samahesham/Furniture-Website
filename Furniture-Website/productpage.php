               ...
               echo $e->getMessage();
                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                        ...
                        <div class="md-prod-page-in">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            ...
                                            <img src="./admin/upload_images/<?php echo $furniture['image'] ?>" alt=""
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="price-box-right">
                                    ...
                                    <h5><i class="fa fa-clock-o" aria-hidden="true"></i> <strong>16 hours</strong> avg.
                                        responsive
                                        time</h5>
                                </div>
                            </div>
                            <div class="btn-dit-list clearfix">
                                ...
                                <div class="right-dit-p">
                                    <div class="like-list">
                                        <ul>
                                            <li>
                                                <div class="im-b"><img class="" src="images/list-img-01.png" alt="">
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="im-b"><i class="fa fa-ellipsis-h" aria-hidden="true"></i>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                ...
                                <br>
                                <p>Small:
                                    <!-- H 25 cm / &Oslash; 12 cm -->
                                    <?php echo $furniture['small'] ?>
                                </p>
                                <p>Large
                                    <!-- H 24 cm / &Oslash; 25 cm -->
                                    <?php echo $furniture['large'] ?>
                                </p>
                            </div>
                            <div class="spe-a">
                    ...
                    <div class="similar-box">
                        <h2>Similiar products from <?php echo $furniture['title'] ?></h2>

                        <?php
                  $displayedProductCategory = $furniture['categoryID'];
                  $furnitureID = $_POST["furnitureID"];
                  // $sameFurn = $db->selectSameCat('*', 'furniture', '1 ORDER BY added_date DESC LIMIT 4', '1');
                  // var_dump($displayedProductCategory);
                  // $query = "SELECT * FROM furniture WHERE categoryID = '$displayedProductCategory' AND furnitureID != '$furnitureID'";
                  $result = $db->select('*', 'furniture', "categoryID = '$displayedProductCategory' AND furnitureID != '$furnitureID' ORDER BY addedDate DESC LIMIT 4");
                  $sameCategoryProducts = $result->fetchAll(PDO::FETCH_ASSOC);
                  // var_dump($sameCategoryProducts);
                  foreach ($sameCategoryProducts as $smCatr) {
                  ?>
                            ...
                            <div class="col-md-6">
                                <div class="small-box-c">
                                    <div class="small-img-b">
                                        ...
                                        <img src="./admin/upload_images/<?php echo $smCatr['image'] ?>" alt=""
                                    ...
                                    <div class="dit-t clearfix">
                                        <div class="left-ti">
                                            <h4>
                                                <!-- Product -->
                                                <?php echo $smCatr['title']; ?>
                                            </h4>
                                            <p>By <span>Beko</span> under <span>Lights</span></p>
                                        </div>
                                        <a href="#" tabindex="0">
                                            <!-- $1220 -->
                                            <?php echo $smCatr['price']; ?>
                                        </a>
                                    </div>
                                    <div class="prod-btn">
                                        <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
