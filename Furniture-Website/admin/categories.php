            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.php" class="site_title"><i class="fa fa-graduation-cap"></i></i> <span>Furniture
                                Admin</span></a>
                    </div>
            ...
            <div class="right_col" role="main">
                <div class="">
                  ...
                  if (isset($_POST['delete'])) {
                    ...
                    $sqlCheck = $db->select('COUNT(*) as furnitureCount', 'furniture', "categoryID='$categoryID'");

                    $row = $sqlCheck->fetch(PDO::FETCH_ASSOC);
                    // var_dump($row);
                    $furnitureCount = $row['furnitureCount'];
                    if ($furnitureCount > 0) {
                      echo "Can't delete the category as it has associated furniture records.";
}else{
  $data = $db->delete("category", "categoryID='$categoryID'");
}              
                    // if($sqlCheck->){
                    ...
                    // $sqlCheck = "SELECT COUNT(*) AS furnitureCount FROM furniture WHERE categoryID = $categoryID";
