...
<head>
    ...
    <title>Furniture Admin | Add User</title>
                                    ...
                                    try {
                                        ...
                                        if (isset($_POST["submit"])) {
                                            ...
                                            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                                ...
                                                $db->insert('users', "fullname,username,email,password,active,regDate", "'$fullname','$username','$email','$password','$active',NOW()");
                                            }
                                        }
                                    ...
                                    <form id="demo-form2" method="POST" data-parsley-validate
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="first-name" name="fullname"
                                                    class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
