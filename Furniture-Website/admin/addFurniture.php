...
<head>
    ...
    <title>Furniture Admin | Add Furniture</title>
                                ...
                                <div class="x_content">
									...
									try {
										...
										if (isset($_POST["submit"])) {
											...
											$db->insert("furniture", "description,small,large,price,active,image,title,categoryID,addedDate", "'$description','$small','$large','$price','$active','$image','$title','$categoryID',NOW()");
										}
									} catch (PDOException $errors) {
										echo $errors;
									}
									?>
                                    <!-- Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus voluptatem quod porro commodi animi praesentium laborum optio. Quaerat necessitatibus deserunt, vel voluptas harum eveniet minima soluta, tempore magnam explicabo unde?
									 -->
