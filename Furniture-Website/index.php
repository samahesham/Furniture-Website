        ...
        <div class="main-product">
            <div class="container">
                ...
                <?php
                  ...
                  $data = $db->select("*", "furniture",'1 ORDER BY addedDate DESC LIMIT 8');
                ...
                <div class="row clearfix">
                    ...
                    <form action="productpage.php" method="post">
                        <input type="hidden" value="<?php echo $furniture['furnitureID'] ?>" name="furnitureID">
                        <div class="col-lg-3 col-sm-6 col-md-3">

                            <!-- <a href="productpage.php"> -->
                            <button type="submit" value="showDetails">
                                <div class="box-img">
                                    <h4>
                                        <!-- Product -->
                        ...
                        <div class="prod-box">
                            ...
                            <div class="prod-dit clearfix">
                                ...
                                <div class="dit-btn clearfix">
                                    <a class="wis" href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to
                                        wishlist </a>
                                    <a class="thi" href="#"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Like
                                        this</a>
                                </div>
                            </div>
                        </div>
