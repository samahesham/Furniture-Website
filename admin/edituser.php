				...
				<div class="">
					...
					try {
						...
						if (isset($_POST["update"])) {
							...
							$db->update('users', "fullname='$fullname',username='$username',email='$email',password='$password',active='$active'", "id='$id'");
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="POST" action="<?php echo $_SERVER["PHP_SELF"] ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="active" <?php if (isset($user['active'])) {
																											if ($user['active'] == 1) {
																										?> checked="checked" <?php
																															}
																														}  ?>>
