...
// session_start();
            ...
            <div class="right_col" role="main">
                <div class="">
                  ...
                  $data = $db->select("*", "furniture");
                  $furnitures = $data->fetchAll(pdo::FETCH_ASSOC);
                  if (isset($_POST['delete'])) {
                    $furnitureID = $_POST['furnitureID'];
                    $data = $db->delete("furniture", "furnitureID='$furnitureID'");
                            ...
                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!-- Yes -->
                                                                <?php
                                  if ($furniture['active'] == 0 || $furniture['active'] == null) {
                                    echo 'No';
                                  } else {
                                    echo 'Yes';
                                  }
                                  ?>
                                                            ...
                                                            <td>
                                                                <form action="editFurniture.php" method="post">
                                                                    <input type="hidden"
                                                                        value="<?php echo $furniture['furnitureID'] ?>"
                                                                        name="furnitureID">
